...
**pandoc** R package is currently an experimental package aiming mainly to help maintainers of R Markdown ecosystem. 
...
> This repo is currently private and a Github PAT must be set for the above function to work
