...
- Managing locally installed version of Pandoc as versions installed by
  ...
  - [`pandoc_installed_versions()`](https://cderv.github.io/pandoc/dev/reference/pandoc_installed_versions.md)
    ...
    [`pandoc::pandoc_is_installed()`](https://cderv.github.io/pandoc/dev/reference/pandoc_installed_versions.md)
    ,
...
- Using easily one of the installed version with **rmarkdown** (i.e
  ...
  will use the version activated by this pandoc)
...
- to easily access information in R usually requiring command line
  ...
  - [`pandoc_version()`](https://cderv.github.io/pandoc/dev/reference/pandoc_version.md),
    ...
    , and all other wrappers…
- opening Pandoc’s resources from R
  - [`pandoc::pandoc_browse_manual()`](https://cderv.github.io/pandoc/dev/reference/pandoc_browse_manual.md),
    [`pandoc::pandoc_browse_extension()`](https://cderv.github.io/pandoc/dev/reference/pandoc_browse_extension.md)
    , ….
